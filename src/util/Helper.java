...
public class Helper {
	...
	/**
	 * Get a {@link Color} that has the same color as base color, but has a
	...
	/**
	 * Blend two {@link Color}s with specified ratio by linear interpolation
	 * method in each channel.
	 * 
	 * @param a
	 ...
	 * 
	 * @param t
	 *            the x-axis position in the graph, ranged from {@code 0.0f} and
	 *            {@code 1.0f}, inclusive.
	 * @param easeIn
	 ...
	 * @throws IllegalArgumentException
	 *             if both {@code easeIn} and {@code easeOut} is both false. In
	 *             this case, use {@link interpolate} instead.
	 */
	...
	/**
	 * Calculate interpolation between start point and end point using sine
	 * function.
	 * 
	 * @param a
	...
	/**
	 * Calculate interpolation between start point and end point using linear
	 * function.
	 * 
	 * @param a
	 *            the value of start point
	...
	/**
	 * Calculate interpolation between start vector and end vector using linear
	 * function.
	 * 
	 * @param a
	 *            the value of start point
